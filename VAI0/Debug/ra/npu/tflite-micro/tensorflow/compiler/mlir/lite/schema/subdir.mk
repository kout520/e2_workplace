...
CC_DEPS += \
./ra/npu/tflite-micro/tensorflow/compiler/mlir/lite/schema/schema_utils.d 
...
ra/npu/tflite-micro/tensorflow/compiler/mlir/lite/schema/%.o: ../ra/npu/tflite-micro/tensorflow/compiler/mlir/lite/schema/%.cc
	@echo 'Building file: $<'
