...
#define VECTOR_NUMBER_GLCDC_LINE_DETECT ((IRQn_Type) 14) /* GLCDC LINE DETECT (Specified line) */
#define GLCDC_LINE_DETECT_IRQn          ((IRQn_Type) 14) /* GLCDC LINE DETECT (Specified line) */
