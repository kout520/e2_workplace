...
extern const size_t ai_tensorArenaSize = 512 * 1024;

#if (TENSOR_ARENA_ALLOCATION == ALLOCATE_TO_ONCHIP_RAM)
uint8_t ai_tensorArena[ai_tensorArenaSize] BSP_ALIGN_VARIABLE(16);
#elif (TENSOR_ARENA_ALLOCATION == ALLOCATE_TO_SDRAM)
uint8_t ai_tensorArena[ai_tensorArenaSize] BSP_PLACE_IN_SECTION(".sdram") BSP_ALIGN_VARIABLE(16);
#else
