...
__attribute__((aligned(16))) uint8_t sub_0000_arena[524288];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0000_fast_scratch[524288];
...
int sub_0000_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0000_model with size 465056 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0000_model_data;
  base_addrs_size[0] = sub_0000_model_data_size;
  // Buffer sub_0000_arena with size 524288 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[1] = 524288;

  // Buffer sub_0000_fast_scratch with size 524288 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[2] = 524288;

  // Buffer input_tensor_0 with size 49152 and address: 262144
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0000_arena+262144);
  base_addrs_size[3] = 49152;

  // Buffer output_tensor_0 with size 5 and address: 16
  if (clean_outputs) {
    memset(sub_0000_arena + 16, 0, 5);
  }
