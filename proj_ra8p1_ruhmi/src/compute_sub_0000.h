...
void compute_sub_0000(
  ...
  uint8_t* main_storage, // should provide at least 33297 bytes of storage

  // inputs
  
  const uint8_t serving_default_input_1_0[784], // 1,28,28,1
  

  // outputs
  
  uint8_t StatefulPartitionedCall_0_70018[10]  // 1,10
