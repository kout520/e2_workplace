...
__attribute__((aligned(32), section(".sdram_noinit"))) uint8_t sub_0000_arena[884736];
...
int sub_0000_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0000_model with size 6299792 and address: 4294967295
  ...
  // Buffer output_tensor_0 with size 10368 and address: 101376
  if (clean_outputs) {
    memset(sub_0000_arena + 101376, 0, 10368);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0000_arena+101376);
  base_addrs_size[4] = 10368;

  // Buffer output_tensor_1 with size 648 and address: 36864
  if (clean_outputs) {
    memset(sub_0000_arena + 36864, 0, 648);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0000_arena+36864);
  base_addrs_size[5] = 648;

  // Buffer output_tensor_2 with size 2592 and address: 37520
  if (clean_outputs) {
    memset(sub_0000_arena + 37520, 0, 2592);
  }
  base_addrs[6] = (uint64_t)(uintptr_t) (sub_0000_arena+37520);
  base_addrs_size[6] = 2592;
