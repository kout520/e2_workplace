...
__attribute__((aligned(32), section(".sdram_noinit"))) uint8_t sub_0004_arena[49904];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0004_fast_scratch[49904];
...
int sub_0004_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0004_model with size 0 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0004_model_data;
  base_addrs_size[0] = sub_0004_model_data_size;
  // Buffer sub_0004_arena with size 49904 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0004_arena+0);
  base_addrs_size[1] = 49904;

  // Buffer sub_0004_fast_scratch with size 49904 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0004_arena+0);
  base_addrs_size[2] = 49904;

  // Buffer input_tensor_0 with size 10368 and address: 39536
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0004_arena+39536);
  base_addrs_size[3] = 10368;

  // Buffer input_tensor_1 with size 2592 and address: 36944
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0004_arena+36944);
  base_addrs_size[4] = 2592;

  // Buffer input_tensor_2 with size 648 and address: 36288
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0004_arena+36288);
  base_addrs_size[5] = 648;

  // Buffer output_tensor_0 with size 13608 and address: 36288
  if (clean_outputs) {
    memset(sub_0004_arena + 36288, 0, 13608);
  }
  base_addrs[6] = (uint64_t)(uintptr_t) (sub_0004_arena+36288);
  base_addrs_size[6] = 13608;
