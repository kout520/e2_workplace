...
#endif
//热点
#define User_ESP8266_SSID     "222"          					//wifi名
#define User_ESP8266_PWD      "3429630359"     	 					//wifi密码
//UDP
#define SERVER_IP                "192.168.2.165"      //要连接的服务器的 IP
#define SERVER_PORT              "8080"               //要连接的服务器的端口
#define LOCAL_PORT              "8080"               //本地端口
//TCP
#define User_ESP8266_TCPServer_IP     "192.168.0.100"   //服务器IP
...
#define User_ESP8266_password			"Tbjptr74&"        				//用于登录 MQTT 服务器 的 password, 最长 64 字节
#define User_ESP8266_MQTTServer_IP     "159.75.161.237"	//MQTT本地服务器IP，EMQX本地服务器的IP 
#define User_ESP8266_MQTTServer_PORT   1883    					//服务器端口号
#define User_ESP8266_MQTTServer_Topic  "ledctl"    				//订阅MQTT主题
