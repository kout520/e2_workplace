...
// 液晶控制口置1操作语句宏定义
#define LCD_SDA_SET    R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_01, BSP_IO_LEVEL_HIGH)
#define LCD_SCL_SET    R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_02, BSP_IO_LEVEL_HIGH)
#define LCD_CS_SET     R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_03, BSP_IO_LEVEL_HIGH)
#define LCD_RST_SET    R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_04, BSP_IO_LEVEL_HIGH)
#define LCD_RS_SET     R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_05, BSP_IO_LEVEL_HIGH)
#define LCD_BLK_SET    R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_07_PIN_15, BSP_IO_LEVEL_HIGH)

// 液晶控制口置0操作语句宏定义
#define LCD_SDA_CLR    R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_01, BSP_IO_LEVEL_LOW)
#define LCD_SCL_CLR    R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_02, BSP_IO_LEVEL_LOW)
#define LCD_CS_CLR     R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_03, BSP_IO_LEVEL_LOW)
#define LCD_RST_CLR    R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_04, BSP_IO_LEVEL_LOW)
#define LCD_RS_CLR     R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_06_PIN_05, BSP_IO_LEVEL_LOW)
#define LCD_BLK_CLR    R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_07_PIN_15, BSP_IO_LEVEL_LOW)
...
#define LCD_Delay_us(us)   R_BSP_SoftwareDelay((us), BSP_DELAY_UNITS_MICROSECONDS)
#define LCD_Delay_ms(ms)   R_BSP_SoftwareDelay((ms), BSP_DELAY_UNITS_MILLISECONDS)
