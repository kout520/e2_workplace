...
//读取函数
void ap3216c_read_all_data(void)
{
    uint16_t light = ap3216c_read_ambient_light();
    uint16_t ps = ap3216c_read_ps_data();
    uint16_t ir = ap3216c_read_ir_data();

    printf("Light: %d, Proximity: %d, IR: %d\n",
        light, ps == 55555 ? -1 : ps, ir);
}
