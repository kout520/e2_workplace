...
{ .channel = 1, .pcm_width = I2S_PCM_WIDTH_32_BITS, .operating_mode = I2S_MODE_MASTER, .word_length =
          I2S_WORD_LENGTH_32_BITS,
  .ws_continue = I2S_WS_CONTINUE_ON, .p_callback = i2s1_callback, .p_context = NULL, .p_extend = &g_i2s1_cfg_extend,
...
/* Actual period: 9.36e-7 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xea,
  .duty_cycle_counts = 0x75, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = NULL,
...
gpt_instance_ctrl_t g_timer_1ms_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_1ms_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_timer_1ms_extend =
        { .gtioca =
        { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT0_COMPARE_F,
          ...
          .capture_filter_gtiocb = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_timer_1ms_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_1ms_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.001 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x3d090,
  .duty_cycle_counts = 0x1e848, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = timer_1ms_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
iic_master_instance_ctrl_t g_i2c2_ctrl;
const iic_master_extended_cfg_t g_i2c2_extend =
...
#endif
  .ipl = (12),
  .p_extend = &g_i2c2_extend, };
/* Instance structure to use this module. */
const i2c_master_instance_t g_i2c2 =
{ .p_ctrl = &g_i2c2_ctrl, .p_cfg = &g_i2c2_cfg, .p_api = &g_i2c_master_on_iic };
...
{ .clock = SCI_B_UART_CLOCK_INT, .rx_edge_start = SCI_B_UART_START_BIT_FALLING_EDGE, .noise_cancel =
          SCI_B_UART_NOISE_CANCELLATION_DISABLE,
  .rx_fifo_trigger = SCI_B_UART_RX_FIFO_TRIGGER_MAX, .p_baud_setting = &g_uart6_baud_setting, .flow_control =
          SCI_B_UART_FLOW_CONTROL_RTS,
#if 0xFF != 0xFF
                .flow_control_pin       = BSP_IO_PORT_FF_PIN_0xFF,
                #else
...
/* Actual period: 4e-8 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xa,
  .duty_cycle_counts = 0x5, .source_div = (timer_source_div_t) 0, .channel = 4, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
